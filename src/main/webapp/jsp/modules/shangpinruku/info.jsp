						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="fuwuzhanghao" name="fuwuzhanghao" class="form-control" v-model="ruleForm.fuwuzhanghao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>服务人名</label>

									<input id="fuwurenming" name="fuwurenming" class="form-control" v-model="ruleForm.fuwurenming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>入库说明</label>

									<input id="rukushuoming" name="rukushuoming" class="form-control" v-model="ruleForm.rukushuoming" readonly>
									</div>
