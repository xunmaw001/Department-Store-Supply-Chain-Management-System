...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<label>销售时间</label>
									<input id="xiaoshoushijian_start" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
									至
									<input id="xiaoshoushijian_end" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xiaoshouzhanghao')">销售账号<i id="xiaoshouzhanghaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xiaoshourenming')">销售人名<i id="xiaoshourenmingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xiaoshoushuoming')">销售说明<i id="xiaoshoushuomingIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#xiaoshoushijian_start').val() != null && $('#xiaoshoushijian_start').val() != ''){
				searchForm.xiaoshoushijian_start = $('#xiaoshoushijian_start').val();
			}
			if($('#xiaoshoushijian_end').val() != null && $('#xiaoshoushijian_end').val() != ''){
				searchForm.xiaoshoushijian_end = $('#xiaoshoushijian_end').val();
			}
			getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangpinxiaoshou/page","GET",{
				...
				xiaoshoushijian_start : searchForm.xiaoshoushijian_start,
				xiaoshoushijian_end : searchForm.xiaoshoushijian_end,
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var xiaoshouzhanghaoCell  = document.createElement('td');

						 xiaoshouzhanghaoCell.innerHTML = item.xiaoshouzhanghao;

			row.appendChild(xiaoshouzhanghaoCell);
			var xiaoshourenmingCell  = document.createElement('td');

						 xiaoshourenmingCell.innerHTML = item.xiaoshourenming;

			row.appendChild(xiaoshourenmingCell);
			var xiaoshoushuomingCell  = document.createElement('td');

						 xiaoshoushuomingCell.innerHTML = item.xiaoshoushuoming;

			row.appendChild(xiaoshoushuomingCell);
