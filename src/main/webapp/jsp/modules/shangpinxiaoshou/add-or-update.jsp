...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>销售时间</label>
										<div id="xiaoshoushijianDate" class="input-append date form_datetime">
											<input id="xiaoshoushijian-input" name="xiaoshoushijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>销售账号</label>
										<input name="xiaoshouzhanghao" id="xiaoshouzhanghao" name="xiaoshouzhanghao" class="form-control" placeholder="销售账号">
									</div>
									<div class="form-group col-md-6">
										<label>销售人名</label>
										<input name="xiaoshourenming" id="xiaoshourenming" name="xiaoshourenming" class="form-control" placeholder="销售人名">
									</div>
									<div class="form-group col-md-6">
										<label>销售说明</label>
										<input name="xiaoshoushuoming" id="xiaoshoushuoming" name="xiaoshoushuoming" class="form-control" placeholder="销售说明">
									</div>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#xiaoshoushijian-input").val(getCurDateTime());
			$("#xiaoshoushijianDate").datetimepicker({ 
				autoclose: true,
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.xiaoshouzhanghao != null && res.data.xiaoshouzhanghao != ''){
							$('#xiaoshouzhanghao').val(res.data.xiaoshouzhanghao)
							$("#xiaoshouzhanghao").attr('readonly','readonly');
						}
						if(res.data !=null && res.data.xiaoshourenming != null && res.data.xiaoshourenming != ''){
							$('#xiaoshourenming').val(res.data.xiaoshourenming)
							$("#xiaoshourenming").attr('readonly','readonly');
						}
						$(validform());
					}
				});
		...
		function dataBind(){
			...
			$("#xiaoshouzhanghao").val(ruleForm.xiaoshouzhanghao);	
			$("#xiaoshourenming").val(ruleForm.xiaoshourenming);	
			$("#xiaoshoushuoming").val(ruleForm.xiaoshoushuoming);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xiaoshouzhanghao != null && res.data.xiaoshouzhanghao != ''){

						$("#xiaoshouzhanghao").val(res.data.xiaoshouzhanghao);
						$("#xiaoshouzhanghao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.xiaoshourenming != null && res.data.xiaoshourenming != ''){

						$("#xiaoshourenming").val(res.data.xiaoshourenming);
						$("#xiaoshourenming").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.xiaoshoushuoming != null && res.data.xiaoshoushuoming != ''){

						$("#xiaoshoushuoming").val(res.data.xiaoshoushuoming);
						$("#xiaoshoushuoming").attr('readonly','readonly');
					}
				}
			});  
            }
