...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>采购管理</span></li>
								<li class="breadcrumb-item active"><span>采购列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">采购列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										采购账号
									</label>
									<input type="text" id="caigouzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入采购账号" aria-controls="tableId">
									<label>
										采购人名
									</label>
									<input type="text" id="caigourenmingSearch" class="form-control form-control-sm" placeholder="请输入采购人名" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#caigouzhanghaoSearch').val() != null && $('#caigouzhanghaoSearch').val() != ''){
				searchForm.caigouzhanghao ="%" +  $('#caigouzhanghaoSearch').val() + "%";
			}
			
			if($('#caigourenmingSearch').val() != null && $('#caigourenmingSearch').val() != ''){
				searchForm.caigourenming ="%" +  $('#caigourenmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("caigou/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				caigouzhanghao : searchForm.caigouzhanghao,	
				caigourenming : searchForm.caigourenming,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("caigou/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"caigou");
