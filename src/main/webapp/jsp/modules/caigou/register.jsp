	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">采购账号</label> 
							<input  name="caigouzhanghao" placeholder="采购账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">采购人名</label> 
							<input  name="caigourenming" placeholder="采购人名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "caigou/register";
				$.ajax({ 
					type: "POST",
					url: url,
