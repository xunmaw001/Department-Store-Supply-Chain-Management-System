...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>服务管理</span></li>
								<li class="breadcrumb-item active"><span>服务列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="fuwuzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入服务账号" aria-controls="tableId">
									<label>
										服务人名
									</label>
									<input type="text" id="fuwurenmingSearch" class="form-control form-control-sm" placeholder="请输入服务人名" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#fuwuzhanghaoSearch').val() != null && $('#fuwuzhanghaoSearch').val() != ''){
				searchForm.fuwuzhanghao ="%" +  $('#fuwuzhanghaoSearch').val() + "%";
			}
			
			if($('#fuwurenmingSearch').val() != null && $('#fuwurenmingSearch').val() != ''){
				searchForm.fuwurenming ="%" +  $('#fuwurenmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fuwu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				fuwuzhanghao : searchForm.fuwuzhanghao,	
				fuwurenming : searchForm.fuwurenming,	
			},(res)=>{
				if(res.code == 0){
					clear();
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fuwu");
