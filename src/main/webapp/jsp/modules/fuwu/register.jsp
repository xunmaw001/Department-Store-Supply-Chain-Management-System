	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">服务账号</label> 
							<input  name="fuwuzhanghao" placeholder="服务账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">服务人名</label> 
							<input  name="fuwurenming" placeholder="服务人名" class="form-control-i">
							</div>
							<div class="form-group">
