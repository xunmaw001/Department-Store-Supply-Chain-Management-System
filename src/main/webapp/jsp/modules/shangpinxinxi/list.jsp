...
<body>
	...
	<script>
		...
		function init() {
			// 满足条件渲染提醒接口
			http("shangpinxinxi/remind/shuliang/1","GET",{
				remindstart:10,
									remindend:1
			},(res)=>{
