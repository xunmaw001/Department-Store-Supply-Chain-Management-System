	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">销售账号</label> 
							<input  name="xiaoshouzhanghao" placeholder="销售账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">销售人名</label> 
							<input  name="xiaoshourenming" placeholder="销售人名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xiaoshou/register";
				$.ajax({ 
					type: "POST",
					url: url,
