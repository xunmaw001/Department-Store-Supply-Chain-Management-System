...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>人事管理</span></li>
								<li class="breadcrumb-item active"><span>人事列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">人事列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										人事账号
									</label>
									<input type="text" id="renshizhanghaoSearch" class="form-control form-control-sm" placeholder="请输入人事账号" aria-controls="tableId">
									<label>
										人事姓名
									</label>
									<input type="text" id="renshixingmingSearch" class="form-control form-control-sm" placeholder="请输入人事姓名" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('renshizhanghao')">人事账号<i id="renshizhanghaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#renshizhanghaoSearch').val() != null && $('#renshizhanghaoSearch').val() != ''){
				searchForm.renshizhanghao ="%" +  $('#renshizhanghaoSearch').val() + "%";
			}
			
			if($('#renshixingmingSearch').val() != null && $('#renshixingmingSearch').val() != ''){
				searchForm.renshixingming ="%" +  $('#renshixingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("renshi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				renshizhanghao : searchForm.renshizhanghao,	
				renshixingming : searchForm.renshixingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var renshizhanghaoCell  = document.createElement('td');

						 renshizhanghaoCell.innerHTML = item.renshizhanghao;

			row.appendChild(renshizhanghaoCell);
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"renshi");
