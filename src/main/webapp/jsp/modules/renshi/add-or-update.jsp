...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑人事</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>人事账号</label>
										<input name="renshizhanghao" id="renshizhanghao" name="renshizhanghao" class="form-control" placeholder="人事账号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>人事姓名</label>
										<input name="renshixingming" id="renshixingming" name="renshixingming" class="form-control" placeholder="人事姓名">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#renshizhanghao").val(ruleForm.renshizhanghao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.renshizhanghao != null && res.data.renshizhanghao != ''){

						$("#renshizhanghao").val(res.data.renshizhanghao);
						$("#renshizhanghao").attr('readonly','readonly');
					}
