	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">人事账号</label> 
							<input  name="renshizhanghao" placeholder="人事账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">人事姓名</label> 
							<input  name="renshixingming" placeholder="人事姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "renshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
