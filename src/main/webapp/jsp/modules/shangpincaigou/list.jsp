...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品采购管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品采购列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品采购列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										商品编号
									</label>
									<input type="text" id="shangpinbianhaoSearch" class="form-control form-control-sm" placeholder="请输入商品编号" aria-controls="tableId">
									<label>
										商品名称
									</label>
									...
									<label>采购时间</label>
									<input id="caigoushijian_start" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
									至
									<input id="caigoushijian_end" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zongji')">总计<i id="zongjiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('caigouzhanghao')">采购账号<i id="caigouzhanghaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('caigourenming')">采购人名<i id="caigourenmingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('caigoushuoming')">采购说明<i id="caigoushuomingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#caigoushijian_start').val() != null && $('#caigoushijian_start').val() != ''){
				searchForm.caigoushijian_start = $('#caigoushijian_start').val();
			}
			if($('#caigoushijian_end').val() != null && $('#caigoushijian_end').val() != ''){
				searchForm.caigoushijian_end = $('#caigoushijian_end').val();
			}
			getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangpincaigou/page","GET",{
				...
				caigoushijian_start : searchForm.caigoushijian_start,
				caigoushijian_end : searchForm.caigoushijian_end,
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var caigoushuliangCell  = document.createElement('td');

						 caigoushuliangCell.innerHTML = item.caigoushuliang;

			row.appendChild(caigoushuliangCell);
			var jiageCell  = document.createElement('td');

						 jiageCell.innerHTML = item.jiage;

			row.appendChild(jiageCell);
			var zongjiCell  = document.createElement('td');

						 zongjiCell.innerHTML = item.zongji;

			row.appendChild(zongjiCell);
			...
			var caigoushijianCell  = document.createElement('td');

						  caigoushijianCell.innerHTML = item.caigoushijian;


			row.appendChild(caigoushijianCell);
			var caigouzhanghaoCell  = document.createElement('td');

						 caigouzhanghaoCell.innerHTML = item.caigouzhanghao;

			row.appendChild(caigouzhanghaoCell);
			var caigourenmingCell  = document.createElement('td');

						 caigourenmingCell.innerHTML = item.caigourenming;

			row.appendChild(caigourenmingCell);
			var caigoushuomingCell  = document.createElement('td');

						 caigoushuomingCell.innerHTML = item.caigoushuoming;

			row.appendChild(caigoushuomingCell);
		...
		function sh(){
			...
			httpJson("shangpincaigou/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
	...
	function printTable() {
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpincaigou/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"shangpincaigou");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"shangpincaigou");
