...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<label>出库时间</label>
									<input id="chukushijian_start" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
									至
									<input id="chukushijian_end" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
	...
	<script>
		...
		function search(){
			...
			if($('#chukushijian_start').val() != null && $('#chukushijian_start').val() != ''){
				searchForm.chukushijian_start = $('#chukushijian_start').val();
			}
			if($('#chukushijian_end').val() != null && $('#chukushijian_end').val() != ''){
				searchForm.chukushijian_end = $('#chukushijian_end').val();
			}
			getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangpinchuku/page","GET",{
				...
				chukushijian_start : searchForm.chukushijian_start,
				chukushijian_end : searchForm.chukushijian_end,
			},(res)=>{
				if(res.code == 0){
					clear();
