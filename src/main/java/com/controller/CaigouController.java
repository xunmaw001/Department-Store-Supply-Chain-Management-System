...
public class CaigouController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CaigouEntity user = caigouService.selectOne(new EntityWrapper<CaigouEntity>().eq("caigouzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"caigou",  "采购" );
    ...
    public R register(@RequestBody CaigouEntity caigou){
    	...
    	CaigouEntity user = caigouService.selectOne(new EntityWrapper<CaigouEntity>().eq("caigouzhanghao", caigou.getCaigouzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        CaigouEntity user = caigouService.selectById(id);
