...
public class ShangpinxiaoshouController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShangpinxiaoshouEntity shangpinxiaoshou, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date xiaoshoushijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date xiaoshoushijianend,
		HttpServletRequest request){

        EntityWrapper<ShangpinxiaoshouEntity> ew = new EntityWrapper<ShangpinxiaoshouEntity>();
                if(xiaoshoushijianstart!=null) ew.ge("xiaoshoushijian", xiaoshoushijianstart);
                if(xiaoshoushijianend!=null) ew.le("xiaoshoushijian", xiaoshoushijianend);
