...
public class RenshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"renshi",  "人事" );
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,RenshiEntity renshi, 
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,RenshiEntity renshi, 
		HttpServletRequest request){
        EntityWrapper<RenshiEntity> ew = new EntityWrapper<RenshiEntity>();
    	PageUtils page = renshiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, renshi), params), params));
		request.setAttribute("data", page);
