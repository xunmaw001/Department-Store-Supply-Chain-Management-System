...
public class RenshiEntity<T> implements Serializable {
	 ...
	 * 设置：人事姓名
	 */
	public void setRenshixingming(String renshixingming) {
		this.renshixingming = renshixingming;
	}
	/**
	 * 获取：人事姓名
	 */
	public String getRenshixingming() {
		return renshixingming;
	}
	/**
	 * 设置：头像
	 */
