...
public interface ShangpinchukuService extends IService<ShangpinchukuEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShangpinchukuEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShangpinchukuEntity> wrapper);
    
    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShangpinchukuEntity> wrapper);
}
